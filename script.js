...
function generatePopup() {
  ...
  if (window.innerWidth < 768) {
    for(let i=0; i<4; i++){
      let popLang = document.createElement('il');
  ...
  let popupContLinks = document.createElement('div');
  ...
  let butLiveLink = document.createElement('button');
  ...
  butLiveLink.addEventListener('click', function() {
    const url = projectsData[0].liveLink;
    window.open(url, '_blank');
  });

  // create svg for the live link
  let LiveLinkSVG = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
  ...
  //path of arrow link
  let pathLiveSVG = document.createElementNS('http://www.w3.org/2000/svg', 'path');
  ...
  let butSourceLink = document.createElement('button');
  ...
  //listener when click button
  butSourceLink.addEventListener('click', function() {
    const url = projectsData[0].sourceLink;
    window.open(url, '_blank');
  });

  // create svg for the source link
  let sourceLinkSVG = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
  ...
  function sourceFun(){
  //path of github link
  let pathSourceSVG = document.createElementNS('http://www.w3.org/2000/svg', 'path');
